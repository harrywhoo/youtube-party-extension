...
export default function App() {
  return (
    // Use bg-bg (which is #1a1a1a) for the overall page
    <div className="min-h-screen flex items-center justify-center bg-bg">
      {/* Inside, a card with bg-bg-dark (#0f0f0f) */}
      <div className="p-6 rounded-xl shadow-lg bg-bg-dark">
...
//       <div className="bg-bg p-6 rounded-xl shadow-lg">
